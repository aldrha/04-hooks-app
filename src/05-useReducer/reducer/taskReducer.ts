...
export const getTaskInicialValue = (): TaskState => {
    ...
    // ! Cuidado ya que el objeto puede ser manipulado
    return result.data;
};
...
export const TaskReducer = (state: TaskState, action: TaskAction): TaskState => {
    switch (action.type) {
        ...
        case 'TOGGLE_TODO': {
            ...
            const completedTodos = updateTodos.filter((todo) => todo.completed).length;
            const pendingTodos = updateTodos.length - completedTodos;
